...
selectTag.forEach((tag, id) => {
    for (const country_code in countries) {
        // selecting English by deafult as FROM language and French as TO language
        let selected;
...
translateBtn.addEventListener("click", () => {
    ...
    let apiUrl = `https://api.mymemory.translated.net/get?q=${text}&langpair=${translateFrom}|${translateTo}&de=jinjames077@gmail.com`;
    // fetching api response and returning it with parsing into js obj
    // in another the method receiving that obj
